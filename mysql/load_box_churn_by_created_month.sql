...
DROP TABLE IF EXISTS `cb_analytics_box_churn_by_created_month`;
CREATE TABLE `cb_analytics_box_churn_by_created_month` ( 
...
LOAD DATA
	INFILE '/tmp/s3/$bucket/from_redshift/box_churn_by_created_month.csv.gz000'
	INTO TABLE `cb_analytics_box_churn_by_created_month`
