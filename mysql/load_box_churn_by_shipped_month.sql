...
DROP TABLE IF EXISTS `cb_analytics_box_churn_by_shipped_month`;
CREATE TABLE `cb_analytics_box_churn_by_shipped_month` ( 
	`shipped_month` VARCHAR(7) NOT NULL,
...
LOAD DATA
	INFILE '/tmp/s3/$bucket/from_redshift/box_churn_by_shipped_month.csv.gz000'
	INTO TABLE `cb_analytics_box_churn_by_shipped_month`
